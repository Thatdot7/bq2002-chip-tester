...
// Counter_v3_0(CaptureMode=3, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=128, CONTROL3=0, ControlRegRemoved=1, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=255, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1, CY_INSTANCE_SHORT_NAME=Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=Counter_1, )
...
module top ;
    ...
    Counter_v3_0_1 Counter_1 (
        ...
        .up_ndown(1'b1),
        .count(Net_209));
    defparam Counter_1.CaptureMode = 3;
    ...
    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_76)
    begin
        cydff_1 <= Net_74;
    end
    assign Net_75 = cydff_1;
    // -- DFF End --


    assign Net_74 = ~Net_75;
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_225)
    begin
        cy_tff_1 <= Net_224^Net_209;
    end
    assign Net_209 = cy_tff_1;
    // -- TFF End --
