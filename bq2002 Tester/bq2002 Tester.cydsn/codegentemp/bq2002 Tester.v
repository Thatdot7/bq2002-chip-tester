// ======================================================================
// bq2002 Tester.v generated from TopDesign.cysch
// 07/02/2015 at 20:05
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=120, Polarity=0, Resolution=8, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_1, CY_INSTANCE_SHORT_NAME=IDAC_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=IDAC_1, )
...
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Debouncer_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\Debouncer_v1_0\Debouncer_v1_0.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__V_CC_net;
	wire [0:0] tmpFB_0__V_CC_net;
	wire [0:0] tmpIO_0__V_CC_net;
	wire [0:0] tmpINTERRUPT_0__V_CC_net;
	electrical [0:0] tmpSIOVREF__V_CC_net;
	...
	cy_psoc3_pins_v1_10
		...
		V_CC
		 (.oe(tmpOE__V_CC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_CC_net[0:0]}),
		  .io({tmpIO_0__V_CC_net[0:0]}),
		  .siovref(tmpSIOVREF__V_CC_net),
		  .interrupt({tmpINTERRUPT_0__V_CC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_CC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__V_SS_net;
	wire [0:0] tmpFB_0__V_SS_net;
	wire [0:0] tmpIO_0__V_SS_net;
	wire [0:0] tmpINTERRUPT_0__V_SS_net;
	electrical [0:0] tmpSIOVREF__V_SS_net;

	cy_psoc3_pins_v1_10
		#(.id("5caf1b50-dc6f-4c52-a1f2-c1fa5d859810"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		V_SS
		 (.oe(tmpOE__V_SS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_SS_net[0:0]}),
		  .io({tmpIO_0__V_SS_net[0:0]}),
		  .siovref(tmpSIOVREF__V_SS_net),
		  .interrupt({tmpINTERRUPT_0__V_SS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_SS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TM_net;
	wire [0:0] tmpFB_0__TM_net;
	wire [0:0] tmpIO_0__TM_net;
	wire [0:0] tmpINTERRUPT_0__TM_net;
	electrical [0:0] tmpSIOVREF__TM_net;

	cy_psoc3_pins_v1_10
		#(.id("d477f6b7-7b37-4401-942f-50adaa574e99"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		TM
		 (.oe(tmpOE__TM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TM_net[0:0]}),
		  .io({tmpIO_0__TM_net[0:0]}),
		  .siovref(tmpSIOVREF__TM_net),
		  .interrupt({tmpINTERRUPT_0__TM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    IDAC_P4_v1_10_0 IDAC_1 (
        .Iout(Net_23));

	wire [0:0] tmpOE__BAT_net;
	wire [0:0] tmpFB_0__BAT_net;
	wire [0:0] tmpIO_0__BAT_net;
	wire [0:0] tmpINTERRUPT_0__BAT_net;
	electrical [0:0] tmpSIOVREF__BAT_net;
	...
	cy_psoc3_pins_v1_10
		...
		BAT
		 (.oe(tmpOE__BAT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BAT_net[0:0]}),
		  .analog({Net_23}),
		  .io({tmpIO_0__BAT_net[0:0]}),
		  .siovref(tmpSIOVREF__BAT_net),
		  .interrupt({tmpINTERRUPT_0__BAT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BAT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__INH_net;
	wire [0:0] tmpFB_0__INH_net;
	wire [0:0] tmpIO_0__INH_net;
	wire [0:0] tmpINTERRUPT_0__INH_net;
	electrical [0:0] tmpSIOVREF__INH_net;

	cy_psoc3_pins_v1_10
		#(.id("ec85788f-4100-4a03-9f59-6df8a1a6f8aa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		INH
		 (.oe(tmpOE__INH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__INH_net[0:0]}),
		  .io({tmpIO_0__INH_net[0:0]}),
		  .siovref(tmpSIOVREF__INH_net),
		  .interrupt({tmpINTERRUPT_0__INH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CC_net;
	wire [0:0] tmpIO_0__CC_net;
	wire [0:0] tmpINTERRUPT_0__CC_net;
	electrical [0:0] tmpSIOVREF__CC_net;
	...
	cy_psoc3_pins_v1_10
		...
		CC
		 (.oe(tmpOE__CC_net),
		  .y({1'b0}),
		  .fb({Net_670}),
		  .io({tmpIO_0__CC_net[0:0]}),
		  .siovref(tmpSIOVREF__CC_net),
		  .interrupt({tmpINTERRUPT_0__CC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_N_net;
	wire [0:0] tmpFB_0__LED_N_net;
	wire [0:0] tmpIO_0__LED_N_net;
	wire [0:0] tmpINTERRUPT_0__LED_N_net;
	electrical [0:0] tmpSIOVREF__LED_N_net;

	cy_psoc3_pins_v1_10
		#(.id("eaa8be6e-80cb-416a-b757-164c21860965"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		LED_N
		 (.oe(tmpOE__LED_N_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_N_net[0:0]}),
		  .io({tmpIO_0__LED_N_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_N_net),
		  .interrupt({tmpINTERRUPT_0__LED_N_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_N_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TS_net;
	wire [0:0] tmpFB_0__TS_net;
	wire [0:0] tmpIO_0__TS_net;
	wire [0:0] tmpINTERRUPT_0__TS_net;
	electrical [0:0] tmpSIOVREF__TS_net;

	cy_psoc3_pins_v1_10
		#(.id("c73a62da-d75f-4f78-928b-10b96609103a"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		TS
		 (.oe(tmpOE__TS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TS_net[0:0]}),
		  .io({tmpIO_0__TS_net[0:0]}),
		  .siovref(tmpSIOVREF__TS_net),
		  .interrupt({tmpINTERRUPT_0__TS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4d6a850f-c040-4931-943d-0eaa0ef1fc26"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Button1_VDD_net;
	wire [0:0] tmpFB_0__Button1_VDD_net;
	wire [0:0] tmpIO_0__Button1_VDD_net;
	wire [0:0] tmpINTERRUPT_0__Button1_VDD_net;
	electrical [0:0] tmpSIOVREF__Button1_VDD_net;

	cy_psoc3_pins_v1_10
		#(.id("bab7034a-0336-4fb5-bd85-574522f3e063"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button1_VDD
		 (.oe(tmpOE__Button1_VDD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button1_VDD_net[0:0]}),
		  .io({tmpIO_0__Button1_VDD_net[0:0]}),
		  .siovref(tmpSIOVREF__Button1_VDD_net),
		  .interrupt({tmpINTERRUPT_0__Button1_VDD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button1_VDD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
