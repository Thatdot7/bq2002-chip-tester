 ...
 **************************************/
#define Counter_1_CAPTURE_MODE_CONF       3u
...
#define Counter_1_DEFAULT_COMPARE_MODE    1u
    ...
    #define Counter_1_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)3u << Counter_1_CTRL_CAPMODE0_SHIFT))
#else    
    #define Counter_1_DEFAULT_CAPTURE_MODE    (3u )
